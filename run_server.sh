...
celery -A project.tasks.celery worker -Q red  --concurrency=250 --loglevel=info --logfile=project/logs/celery.log -n red_worker &
celery -A project.celery worker -Q green --concurrency=250 --loglevel=info --logfile=project/logs/celery.log -n green_worker &
